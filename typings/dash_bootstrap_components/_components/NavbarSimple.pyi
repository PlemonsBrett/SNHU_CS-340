...
- className (string; optional):
    **DEPRECATED** Use `class_name` instead.  Additional CSS classes
    ...
    _type = ...
    @_explicitize_args
    def __init__(self, children: typing.Optional[typing.Union[str, int, float, ComponentType, typing.Sequence[typing.Union[str, int, float, ComponentType]]]] = ..., id: typing.Optional[typing.Union[str, dict]] = ..., *, color: typing.Optional[str] = ..., dark: typing.Optional[bool] = ..., fluid: typing.Optional[bool] = ..., links_left: typing.Optional[bool] = ..., brand: typing.Optional[typing.Union[str, int, float, ComponentType, typing.Sequence[typing.Union[str, int, float, ComponentType]]]] = ..., brand_href: typing.Optional[str] = ..., brand_external_link: typing.Optional[bool] = ..., fixed: typing.Optional[str] = ..., sticky: typing.Optional[str] = ..., expand: typing.Optional[typing.Union[bool, str]] = ..., style: typing.Optional[typing.Any] = ..., class_name: typing.Optional[str] = ..., brand_style: typing.Optional[dict] = ..., key: typing.Optional[str] = ..., className: typing.Optional[str] = ..., **kwargs) -> None:
        ...

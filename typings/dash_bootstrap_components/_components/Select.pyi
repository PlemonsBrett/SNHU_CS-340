...
- className (string; optional):
    **DEPRECATED** Use `class_name` instead.  Additional CSS classes
    ...
    _namespace = ...
    _type = ...
    Options = TypedDict("Options", { "label": typing.Union[str, typing.Union[int, float, numbers.Number]],"value": str,"disabled": NotRequired[bool],"title": NotRequired[str] })
    @_explicitize_args
    def __init__(self, options: typing.Optional[typing.Union[typing.Sequence[typing.Union[str, typing.Union[int, float, numbers.Number]]], dict, typing.Sequence[Options]]] = ..., value: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., id: typing.Optional[typing.Union[str, dict]] = ..., *, placeholder: typing.Optional[str] = ..., disabled: typing.Optional[bool] = ..., style: typing.Optional[typing.Any] = ..., class_name: typing.Optional[str] = ..., required: typing.Optional[typing.Union[Literal["required", "REQUIRED"], bool]] = ..., valid: typing.Optional[bool] = ..., invalid: typing.Optional[bool] = ..., size: typing.Optional[str] = ..., html_size: typing.Optional[str] = ..., name: typing.Optional[str] = ..., persistence: typing.Optional[typing.Union[bool, str, typing.Union[int, float, numbers.Number]]] = ..., persisted_props: typing.Optional[typing.Sequence[Literal["value"]]] = ..., persistence_type: typing.Optional[Literal["local", "session", "memory"]] = ..., key: typing.Optional[str] = ..., className: typing.Optional[str] = ..., **kwargs) -> None:
        ...

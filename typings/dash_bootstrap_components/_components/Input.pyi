...
- autoFocus (a value equal to: 'autoFocus', 'autofocus', 'AUTOFOCUS' | boolean; optional):
    **DEPRECATED** Use `autofocus` instead.  The element should be
    ...
    _type = ...
    @_explicitize_args
    def __init__(self, id: typing.Optional[typing.Union[str, dict]] = ..., *, value: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., n_submit: typing.Optional[typing.Union[int, float, numbers.Number]] = ..., n_blur: typing.Optional[typing.Union[int, float, numbers.Number]] = ..., size: typing.Optional[str] = ..., valid: typing.Optional[bool] = ..., invalid: typing.Optional[bool] = ..., plaintext: typing.Optional[bool] = ..., style: typing.Optional[typing.Any] = ..., class_name: typing.Optional[str] = ..., type: typing.Optional[Literal["text", "number", "password", "email", "range", "search", "tel", "url", "hidden", "time"]] = ..., step: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., disabled: typing.Optional[bool] = ..., placeholder: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., debounce: typing.Optional[typing.Union[bool, typing.Union[int, float, numbers.Number]]] = ..., html_size: typing.Optional[str] = ..., autocomplete: typing.Optional[str] = ..., autofocus: typing.Optional[typing.Union[Literal["autoFocus", "autofocus", "AUTOFOCUS"], bool]] = ..., inputmode: typing.Optional[Literal["verbatim", "latin", "latin-name", "latin-prose", "full-width-latin", "kana", "katakana", "numeric", "tel", "email", "url"]] = ..., list: typing.Optional[str] = ..., max: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., maxlength: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., min: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., minlength: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., required: typing.Optional[typing.Union[Literal["required", "REQUIRED"], bool]] = ..., readonly: typing.Optional[typing.Union[bool, Literal["readOnly", "readonly", "READONLY"]]] = ..., name: typing.Optional[str] = ..., pattern: typing.Optional[str] = ..., tabindex: typing.Optional[str] = ..., persistence: typing.Optional[typing.Union[bool, str, typing.Union[int, float, numbers.Number]]] = ..., persisted_props: typing.Optional[typing.Sequence[Literal["value"]]] = ..., persistence_type: typing.Optional[Literal["local", "session", "memory"]] = ..., key: typing.Optional[str] = ..., className: typing.Optional[str] = ..., tabIndex: typing.Optional[str] = ..., maxLength: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., minLength: typing.Optional[typing.Union[str, typing.Union[int, float, numbers.Number]]] = ..., inputMode: typing.Optional[Literal["verbatim", "latin", "latin-name", "latin-prose", "full-width-latin", "kana", "katakana", "numeric", "tel", "email", "url"]] = ..., autoComplete: typing.Optional[str] = ..., autoFocus: typing.Optional[typing.Union[Literal["autoFocus", "autofocus", "AUTOFOCUS"], bool]] = ..., **kwargs) -> None:
        ...

...
- labelCheckedClassName (string; optional):
    **DEPRECATED** Use `label_checked_class_name` instead.  Additional
    ...
    _namespace = ...
    _type = ...
    Options = TypedDict("Options", { "label": typing.Union[str, int, float, ComponentType, typing.Sequence[typing.Union[str, int, float, ComponentType]]],"value": typing.Union[str, typing.Union[int, float, numbers.Number]],"disabled": NotRequired[bool],"input_id": NotRequired[str],"label_id": NotRequired[str] })
    @_explicitize_args
    def __init__(self, options: typing.Optional[typing.Union[typing.Sequence[typing.Union[str, typing.Union[int, float, numbers.Number]]], dict, typing.Sequence[Options]]] = ..., value: typing.Optional[typing.Sequence[typing.Union[str, typing.Union[int, float, numbers.Number]]]] = ..., id: typing.Optional[typing.Union[str, dict]] = ..., *, inline: typing.Optional[bool] = ..., switch: typing.Optional[bool] = ..., style: typing.Optional[typing.Any] = ..., class_name: typing.Optional[str] = ..., input_style: typing.Optional[dict] = ..., input_checked_style: typing.Optional[dict] = ..., input_class_name: typing.Optional[str] = ..., input_checked_class_name: typing.Optional[str] = ..., label_style: typing.Optional[dict] = ..., label_class_name: typing.Optional[str] = ..., label_checked_style: typing.Optional[dict] = ..., label_checked_class_name: typing.Optional[str] = ..., name: typing.Optional[str] = ..., persistence: typing.Optional[typing.Union[bool, str, typing.Union[int, float, numbers.Number]]] = ..., persisted_props: typing.Optional[typing.Sequence[Literal["value"]]] = ..., persistence_type: typing.Optional[Literal["local", "session", "memory"]] = ..., key: typing.Optional[str] = ..., className: typing.Optional[str] = ..., inputClassName: typing.Optional[str] = ..., inputStyle: typing.Optional[dict] = ..., inputCheckedStyle: typing.Optional[dict] = ..., inputCheckedClassName: typing.Optional[str] = ..., labelStyle: typing.Optional[dict] = ..., labelClassName: typing.Optional[str] = ..., labelCheckedStyle: typing.Optional[dict] = ..., labelCheckedClassName: typing.Optional[str] = ..., **kwargs) -> None:
        ...

...
class BaseFigure:
    ...
    def __reduce__(self): # -> tuple[type[Self], tuple[dict[str, list[Any] | Any]]]:
        """
    ...
    def __getitem__(self, prop): # -> tuple[Any, ...] | Any | Self:
        ...
    ...
    def pop(self, key, *args): # -> tuple[Any, ...] | Any | Self:
        """
    ...
    @property
    def layout(self): # -> tuple[Any, ...] | Any | Self:
        """
    ...
    def to_plotly_json(self): # -> dict[str, list[Any] | Any]:
        """
    ...
    def to_image(self, *args, **kwargs): # -> bytes | Any:
        """
...
class BasePlotlyType:
    ...
    @property
    def figure(self): # -> <subclass of BasePlotlyType and BaseFigure>:
        """

...
class Title(_BaseLayoutHierarchyType):
    ...
    @property
    def subtitle(self): # -> tuple[Any, ...] | Self | None:
        """
    ...
    def __init__(self, arg=..., automargin=..., font=..., pad=..., subtitle=..., text=..., x=..., xanchor=..., xref=..., y=..., yanchor=..., yref=..., **kwargs) -> None:
        """

...
- zIndexOffset (number; optional):
    ...
    Icon = TypedDict("Icon", { "iconUrl": str,"crossOrigin": NotRequired[typing.Union[Literal["anonymous"], Literal["use-credentials"]]],"iconRetinaUrl": NotRequired[str],"iconSize": NotRequired[typing.Any],"iconAnchor": NotRequired[typing.Any],"popupAnchor": NotRequired[typing.Any],"tooltipAnchor": NotRequired[typing.Any],"shadowUrl": NotRequired[str],"shadowRetinaUrl": NotRequired[str],"shadowSize": NotRequired[typing.Any],"shadowAnchor": NotRequired[typing.Any],"className": NotRequired[str],"pane": NotRequired[str],"attribution": NotRequired[str] })

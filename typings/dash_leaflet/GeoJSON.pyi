...
- zoomToBoundsOnClick (boolean; optional):
    ...
    _namespace = ...
    _type = ...
    FormatOptionsRect = TypedDict("FormatOptionsRect", { "minX": typing.Union[int, float, numbers.Number],"minY": typing.Union[int, float, numbers.Number],"maxX": typing.Union[int, float, numbers.Number],"maxY": typing.Union[int, float, numbers.Number] })
    FormatOptions = TypedDict("FormatOptions", { "rect": "FormatOptionsRect" })
    ...
    @_explicitize_args
    def __init__(self, children: typing.Optional[typing.Union[str, int, float, ComponentType, typing.Sequence[typing.Union[str, int, float, ComponentType]]]] = ..., interactive: typing.Optional[bool] = ..., bubblingMouseEvents: typing.Optional[bool] = ..., attribution: typing.Optional[str] = ..., pane: typing.Optional[str] = ..., style: typing.Optional[typing.Any] = ..., pointToLayer: typing.Optional[typing.Union[str, dict]] = ..., onEachFeature: typing.Optional[typing.Union[str, dict]] = ..., filter: typing.Optional[typing.Union[str, dict]] = ..., coordsToLatLng: typing.Optional[typing.Union[str, dict]] = ..., markersInheritOptions: typing.Optional[bool] = ..., data: typing.Optional[dict] = ..., url: typing.Optional[str] = ..., zoomToBoundsOnClick: typing.Optional[bool] = ..., zoomToBounds: typing.Optional[bool] = ..., hoverStyle: typing.Optional[typing.Union[str, dict]] = ..., hideout: typing.Optional[typing.Union[str, dict]] = ..., format: typing.Optional[Literal["geojson", "geobuf", "flatgeobuf"]] = ..., formatOptions: typing.Optional[FormatOptions] = ..., cluster: typing.Optional[bool] = ..., clusterToLayer: typing.Optional[typing.Union[str, dict]] = ..., spiderfyOnMaxZoom: typing.Optional[bool] = ..., superClusterOptions: typing.Optional[dict] = ..., options: typing.Optional[dict] = ..., id: typing.Optional[typing.Union[str, dict]] = ..., loading_state: typing.Optional[dict] = ..., eventHandlers: typing.Optional[dict] = ..., disableDefaultEventHandlers: typing.Optional[bool] = ..., n_clicks: typing.Optional[typing.Union[int, float, numbers.Number]] = ..., clickData: typing.Optional[ClickData] = ..., n_dblclicks: typing.Optional[typing.Union[int, float, numbers.Number]] = ..., dblclickData: typing.Optional[DblclickData] = ..., **kwargs) -> None:
        ...
